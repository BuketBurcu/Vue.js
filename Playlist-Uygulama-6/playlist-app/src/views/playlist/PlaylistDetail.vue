  ...
  <div>
    ...
    <div v-if="playlist" class="playlist-details">
      ...
      <div class="song-list">
        ...
        <div v-for="song in playlist.song" :key="song.id" class="single-song"<div>
          <div class="details">
            <h3>{{song.title}}</h3>
            <p>{{song.artist}}</p>
          </div>
...
<script>
import AddSong from "../../components/useStorage";
...
export default {
    ...
    setup(props){
      ...
      const ownership=computed(()=>{
        return  (playlist.value && user.value&&user.value.uid===playlis.value.userId);
      });
